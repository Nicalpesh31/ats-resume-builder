...
const ResumeStudent = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    summary: "",
    skills: "",
    education: [{ degree: "", institution: "", year: "", marks: "" }],
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {formData.photo && (
            <img src={formData.photo} alt="Profile" className={styles.previewPhoto} />
          )}
          ...
          {formData.education.map((edu, index) => (
            <div key={index} className={styles.dynamicField}>
              ...
              <input type="number" placeholder="Percentage/CGPA" value={edu.marks} onChange={(e) => handleDynamicChange(index, "marks", e.target.value, "education")} />
            </div>
          ))}
          <button type="button" onClick={() => addField("education", { degree: "", institution: "", year: "", marks: "" })}>+ Add Education</button>
